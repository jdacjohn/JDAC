...
Version: 2.2
Plugin URI: https://wordpress.org/extend/plugins/bookingbug
...
function bbug_shortcode($atts) {
	...
	$prms = "<script src='https://www.bookingbug.com/widget";
...
function widget_sideBookingBug() {
	...
	$path = "https://www.bookingbug.com/widget/all?id=" . $bbug_id . "&palette=" . $palette . "&style=small" . "&resize=" . $resize;
?>
