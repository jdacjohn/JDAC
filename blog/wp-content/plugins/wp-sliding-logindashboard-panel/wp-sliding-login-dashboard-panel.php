...
?>
	...
	<div class="tab">
		<ul class="login">
	    	...
	    	<!-- Logout -->
	        <li style="background:none"><a href="<?php echo wp_logout_url(get_permalink()); ?>" rel="nofollow" title="<?php _e('Log out'); ?>"><?php _e('&nbsp;'); ?></a></li>
		
			<li id="toggle">
				<a id="open" class="open" href="#"><?php if ($wp_sliding_panel_replace_default) echo $wp_sliding_panel_li_open_label; else _e('&nbsp;');?></a>
				<a id="close" style="display: none;" class="close" href="#"><?php if ($wp_sliding_panel_replace_default) echo $wp_sliding_panel_li_close_label; _e('&nbsp;');?></a>
			</li>
